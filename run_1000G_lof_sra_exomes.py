...
root = '/net/snowwhite/home/trubetsk/projects/gotcloud_development/streaming_experiments/'
snpcall_template_sh = root + 'snpcall/snpcall_scripts/template.sh'
snpcall_template_conf = root + 'snpcall/conf/template.conf'
target_vcf = root + 'data/common_LoF_ExAC/0000_snps.vcf.gz'

call_window = 1
experiment_type = 'exome_sra'
sample_list = root + 'snpcall/sample_lists/1000G_phase3_exome_SRR.list'
